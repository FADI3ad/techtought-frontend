              ...
              <div v-for="course in filteredCourses()" :key="course.id"
                ...
                <div class="w-full md:w-80 h-52 flex-shrink-0 relative overflow-hidden bg-gray-100">
                  ...
                  <div v-else
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-14 w-14 text-primary-200"
                      fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1"
                        d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3
                           6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168
                  ...
                  <div class="absolute top-4 left-4 text-[10px] px-3 py-1 rounded-full font-extrabold uppercase shadow-sm"
                    :class="course.is_free ? 'bg-green-500 text-white' : 'bg-white/90 backdrop-blur-sm text-primary-600'">
                ...
                <div class="p-6 flex flex-col justify-between flex-grow">
                  <div>
                    <div class="flex justify-between items-start gap-4 mb-2">
                      <h3 class="font-bold text-xl text-[#0f172a] leading-snug group-hover:text-primary-600 transition-colors">
                        {{ course.title }}
                      </h3>
                  ...
                  <div class="flex items-center justify-between mt-auto pt-4 border-t border-gray-50">
                    <span class="text-xs font-semibold px-3 py-1 rounded-full"
                      :class="course.lang === 'AR' ? 'bg-orange-50 text-orange-600' : 'bg-primary-50 text-primary-600'">
